...
public class Funcionario {
    ...
    public int converterDataNas(int dia, int mes, int ano) {
        ...
        if (mes > dataAtual.get(Calendar.MONTH) + 1) {
            idade--;
        }
        // verifica se o mês de nascimento é igual ao mês atual e se o dia de nascimento é posterior ao dia atual
        else if (mes == dataAtual.get(Calendar.MONTH) + 1 
